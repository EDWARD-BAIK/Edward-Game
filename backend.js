...
function drawPlayerSkin(ctx, p, legSwing, skinId, baseColor) {
    ...
    const drawArm = (c, isBack) => {
        ...
        else if (isJumpingUp) { endX = startX + (isBack ? -3 : 3); endY = -45; } 
    ...
    switch(skinId) {
        ...
        case 'sonic': drawLegs("#ef4444"); drawArm("#1d4ed8", true); drawBody("#3b82f6"); drawArm("#1d4ed8", false); drawHead("#3b82f6"); drawEye(5, -44, 2, "#fff"); break;
        case 'default':
        default:
