...
function resetGame() {
    ...
    currentThemeIndex = (dimensionMode === 'random') ? 0 : (parseInt(dimensionMode, 10) % themes.length);
...
function gameLoop() {
    ...
    let curTheme = (dimensionMode === 'random') ? themes[currentThemeIndex % themes.length] : themes[parseInt(dimensionMode, 10) % themes.length];
