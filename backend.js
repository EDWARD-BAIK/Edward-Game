...
function gameLoop() {
    ...
    ctx.restore(); 
    ctx.restore(); // FIX: menutup save efek shake awal frame yang dulu tak pernah ditutup, sehingga transform kanvas menumpuk tiap frame dan menyebabkan area hitam terus melebar.
